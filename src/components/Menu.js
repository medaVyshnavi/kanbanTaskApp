  ...
  return (
    <>
        <div
          ...
          } min-h-[322px] w-[295px] absolute top-0 border-r-[1px] block m-auto border-${
        ...
        >
          ...
          <div
            className={`bg-${
              darkMode ? "dark" : "light"
            } flex rounded-md items-center justify-center m-3 py-3 px-2`}
          >
      ...
      {isAddModalOpen && (
        <Modal open={isAddModalOpen} close={handleCloseAddModel}>
          <AddNewBoard close={handleCloseAddModel} />
        </Modal>
      )}
    </>
  );
